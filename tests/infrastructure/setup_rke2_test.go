...
func (i *CreateRKE2ClusterTestSuite) TestCreateRKE2Cluster() {
	...
	file, err := providers.TunnelToProvider(i.terraformConfig.Provider).CreateNonAirgap(file, newFile, tfBlockBody, rootBody, i.terraformConfig, i.terratestConfig, instances)
